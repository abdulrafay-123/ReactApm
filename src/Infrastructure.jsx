...
const Infrastructure = () => {
  ...
  {activeGraph === 'cpuChart' && (
    <LineChart data={cpuUsageData} chartId="cpuChartModal" width={900} isModalOpen={true} height={400} />
  )}
  ...
  {activeGraph === 'memoryChart' && (
    ...
    width={900} isModalOpen={false} height={400}
  />
  )}
  {activeGraph === 'diskChart' && (
    <LineChart data={diskUsageData} chartId="diskChartModal" width={900} isModalOpen={true} height={400} />
  )}
  {activeGraph === 'networkChart' && (
    <LineChart data={networkTrafficData} chartId="networkChartModal" width={900} isLatencyChart={false} isModal={true}  height={400}/>
  )}
</Modal>
